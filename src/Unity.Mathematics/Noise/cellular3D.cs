...
namespace Unity.Mathematics
{
    public static partial class noise
    {
        ...
        public static float2 cellular(float3 P)
        {
            ...
            float3 Pfx = Pf.x + math.float3(1.0f, 0.0f, -1.0f);
            float3 Pfy = Pf.y + math.float3(1.0f, 0.0f, -1.0f);
            float3 Pfz = Pf.z + math.float3(1.0f, 0.0f, -1.0f);

            float3 p = permute(Pi.x + math.float3(-1.0f, 0.0f, 1.0f));
