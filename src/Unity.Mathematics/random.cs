...
namespace Unity.Mathematics
{
    ...
    public partial struct Random
    {
        ...
        {
            uint v = NextState();
            return (math.uint2(v) & math.uint2(1, 2)) == 0;
        }
        ...
        {
            uint v = NextState();
            return (math.int3(v) & math.int3(1, 2, 4)) == 0;
        }
        ...
        {
            uint v = NextState();
            return (math.uint4(v) & math.uint4(1, 2, 4, 8)) == 0;
        }
        ...
        {
            return math.int2((int)NextState(), (int)NextState()) ^ -2147483648;
        }
        ...
        {
            return math.int3((int)NextState(), (int)NextState(), (int)NextState()) ^ -2147483648;
        }
        ...
        {
            return math.int4((int)NextState(), (int)NextState(), (int)NextState(), (int)NextState()) ^ -2147483648;
        }
        ...
        public int2 NextInt2(int2 max)
        {
            ...
            return math.int2((int)(NextState() * (ulong)max.x >> 32),
        ...
        public int3 Nextint3(int3 max)
        {
            ...
            return math.int3((int)(NextState() * (ulong)max.x >> 32),
                        (int)(NextState() * (ulong)max.y >> 32),
        ...
        public int4 NextInt4(int4 max)
        {
            ...
            return math.int4((int)(NextState() * (ulong)max.x >> 32),
                        (int)(NextState() * (ulong)max.y >> 32),
                        (int)(NextState() * (ulong)max.z >> 32),
        ...
        public int2 NextInt2(int2 min, int2 max)
        {
            ...
            return math.int2((int)(NextState() * (ulong)range.x >> 32),
        ...
        public int3 Nextint3(int3 min, int3 max)
        {
            ...
            return math.int3((int)(NextState() * (ulong)range.x >> 32),
        ...
        public int4 NextInt4(int4 min, int4 max)
        {
            ...
            return math.int4((int)(NextState() * (ulong)range.x >> 32),
                        (int)(NextState() * (ulong)range.y >> 32),
        ...
        {
            return math.uint2(   (uint)(NextState() * (ulong)max.x >> 32),
        ...
        {
            return math.uint3(   (uint)(NextState() * (ulong)max.x >> 32),
                            (uint)(NextState() * (ulong)max.y >> 32),
        ...
        {
            return math.uint4(   (uint)(NextState() * (ulong)max.x >> 32),
                            (uint)(NextState() * (ulong)max.y >> 32),
                            (uint)(NextState() * (ulong)max.z >> 32),
        ...
        public uint2 Nextuint2(uint2 min, uint2 max)
        {
            ...
            uint2 range = max - min;
            return math.uint2((uint)(NextState() * (ulong)range.x >> 32),
        ...
        public uint3 Nextuint3(uint3 min, uint3 max)
        {
            ...
            uint3 range = max - min;
            return math.uint3((uint)(NextState() * (ulong)range.x >> 32),
        ...
        public uint4 Nextuint4(uint4 min, uint4 max)
        {
            ...
            uint4 range = (uint4)(max - min);
            return math.uint4((uint)(NextState() * (ulong)range.x >> 32),
                         (uint)(NextState() * (ulong)range.y >> 32),
        ...
        {
            return math.asfloat(0x3f800000 | (math.uint2(NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        {
            return math.asfloat(0x3f800000 | (math.uint3(NextState(), NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        {
            return math.asfloat(0x3f800000 | (math.uint4(NextState(), NextState(), NextState(), NextState()) >> 9)) - 1.0f;
        }
        ...
        public double2 NextDouble2()
        {
            ...
            return math.double2(math.asdouble(0x3ff0000000000000 | sx),
        ...
        public double3 NextDouble3()
        {
            ...
            return math.double3(math.asdouble(0x3ff0000000000000 | sx),
        ...
        public double4 NextDouble4()
        {
            ...
            return math.double4(math.asdouble(0x3ff0000000000000 | sx),
                           math.asdouble(0x3ff0000000000000 | sy),
        ...
        {
            float3 rnd = NextFloat3(math.float3(2.0f * math.PI, 2.0f * math.PI, 1.0f));
            float u1 = rnd.z;
            ...
            return math.quaternion(math.select(q.value, -q.value, q.value.w < 0.0f));
        }
